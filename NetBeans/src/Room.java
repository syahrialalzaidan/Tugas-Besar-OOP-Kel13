...
public class Room { // implements ActionListener {
    ...
    public void setSpaceImmediate(int x, int y, Items item, String symbol, String direction) {
        if (!(direction.equalsIgnoreCase("Right") || direction.equalsIgnoreCase("Left")
            ...
            // Orientasi atas
                ...
                // coordinate.getX2() + " " + coordinate.getY2());
            }
    ...
    public Boolean placeObject(Items object) throws Exception {
        ...
        if (object.getX() >= object.getY()) {
            ...
            // Orientasi atas
                ...
                y1 = y2 - object.getX();
                coordinate = new Coordinate(x1, y1, x2, y2);
                // System.out.println(coordinate.getX1() + " " + coordinate.getY1() + " " +
                // coordinate.getX2() + " " + coordinate.getY2());
            }
        ...
        if (checkAvailableSpace(coordinate)) {
            ...
            System.out.println(coordinate.getX1() + " " + coordinate.getY1() + " " + coordinate.getX2() + " "
                    + coordinate.getY2());
    ...
    // {
    // System.out.println("actionPlaceFurniture = " +
    // frame.getActionPlaceFurniture());
    ...
    // placeObject(object , x1 , y1 , direction , color , foregColor ,
    // object.getName());
