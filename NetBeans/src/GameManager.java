        ...
        while (!exit) {
            ...
            if (actionMenuInput.equals("0") || actionMenuInput.equalsIgnoreCase("View Menu")) {
                ...
                while (!(yesno.equals("Y") || yesno.equals("N"))) {
                    ...
                    System.out.println("Silakan masukkan input ulang");
                    System.out.println("");
                    System.out.print("Apakah Anda ingin melakukan action pada object ini? (Y/N) : ");
                ...
                switch (currentObject) {
                    ...
                    case "TV":
                        ...
                        while (!check1) {
                            ...
                            if (inputTime % 30 != 0) {
                                check1 = false;
                                System.out.println("Masukan waktu harus keliapatan 30 detik");
                            } else {
                                check1 = true;
                    ...
                    case "Komputer":
                        ...
                        while (!check2) {
                            ...
                            if (inputTime % 20 != 0) {
                                check2 = false;
                                System.out.println("Masukan waktu harus kelipatan 20 detik");
                            } else {
                                check2 = true;
                    ...
                    case "Kolam Renang":
                        ...
                        while (!check3) {
                            ...
                            if (inputTime % 30 != 0) {
                                check3 = false;
                                System.out.println("Masukan waktu harus kelipatan 30 detik");
                            } else {
                                check3 = true;
                    ...
                    case "Shower":
                        ...
                        while (!check4) {
                            ...
                            if (inputTime % 15 != 0) {
                                check4 = false;
                                System.out.println("Masukan waktu harus keliapatan 15 detik");
                            } else {
                                check4 = true;
                                currentSim.swiming(inputTime);
                            }
